...
var shouldPoll = require('./should-poll.js');
...
module.exports = function send(path, options) {
  ...
  if (!options.cache) {
    ...
    var watchifyBundle = shouldPoll()
    .then(function(poll) {
      bundle = watchify(bundle, {poll: poll, delay: 0});
    ...
    response = watchifyBundle.then(function(bundle) {
    ...
    return {
      ...
      dispose: function () {
        watchifyBundle.then(function(bundle) {
          bundle.close();
        });
      }
    };
