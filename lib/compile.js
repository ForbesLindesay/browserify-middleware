...
function bundleFile(path, options) {
  return browserify({entries: [path], noParse: options.noParse, extensions: options.extensions, resolve: options.resolve, basedir: options.basedir, bundleExternal: options.bundleExternal});
}
function bundleModule(modules, options) {
  var b = browserify({noParse: options.noParse, extensions: options.extensions, resolve: options.resolve, basedir: options.basedir, bundleExternal: options.bundleExternal});
